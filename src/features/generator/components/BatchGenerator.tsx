    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <label htmlFor="batchCount" style={{ fontSize: '0.85rem', fontWeight: 600, color: 'var(--color-text)' }}>
            Cantidad
          </label>
            ...
            {[3, 5, 10, 20].map((n) => (
              <button
                ...
                style={{
                  ...
                  background: batchCount === n ? 'var(--color-accent-soft)' : 'transparent',
                  color: batchCount === n ? 'var(--color-accent)' : 'var(--color-text-secondary)',
                  fontSize: '0.8rem',
                  fontWeight: 600,
                  cursor: 'pointer',
      ...
      {!batchResults && (
        <div style={{
          ...
          <p>Hacé clic en <strong style={{ color: 'var(--color-text-secondary)' }}>Generar</strong> para crear {batchCount} frases</p>
        </div>
      )}
        ...
        <>
          ...
          <button
            ...
            style={{
              ...
              color: copiedAll ? 'var(--color-success)' : 'var(--color-text-secondary)',
              fontSize: '0.8rem',
              fontWeight: 500,
              fontFamily: 'var(--font-sans)',
              transition: 'all var(--duration-fast) var(--ease-out)',
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background: isWarned ? 'rgba(249,115,22,0.04)' : 'var(--color-accent-soft)',
                    transition: 'all var(--duration-fast) var(--ease-out)',
                  }}
                >
                  {/* Number */}
                  ...
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 'var(--radius-sm)',
                      color: copiedIndex === i ? 'var(--color-success)' : 'var(--color-text-tertiary)',
                      transition: 'all var(--duration-fast) var(--ease-out)',
                      flexShrink: 0,
                    }}
                  >
